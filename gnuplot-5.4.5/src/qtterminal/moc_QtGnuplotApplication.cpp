...
void QtGnuplotApplication::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QtGnuplotApplication *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject QtGnuplotApplication::staticMetaObject = { {
    QMetaObject::SuperData::link<QApplication::staticMetaObject>(),
    qt_meta_stringdata_QtGnuplotApplication.data,
    qt_meta_data_QtGnuplotApplication,
    qt_static_metacall,
    nullptr,
    nullptr
} };
